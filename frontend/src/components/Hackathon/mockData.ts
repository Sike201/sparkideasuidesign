...
export const mockHackathons: Hackathon[] = [
  {
    ...
    idea_image_url: "/portfolio/owl.png",
    category: "Tooling",
    usdg_amount: 50000,
    status: "open",
  ...
  },
  {
    ...
    idea_image_url: "/portfolio/bridge.png",
    category: "Infra",
    usdg_amount: 30000,
    status: "voting",
  ...
  },
  {
    ...
    idea_image_url: "/portfolio/basket.png",
    category: "Consumer",
    usdg_amount: 25000,
    status: "completed",
  ...
  },
  {
    ...
    idea_image_url: "/portfolio/credit-spiral.png",
    category: "Infra",
    usdg_amount: 40000,
    status: "upcoming",
  ...
  {
    id: "h5",
    idea_title: "Intent Router Standard",
    idea_slug: "intent-router-standard",
    idea_image_url: "/portfolio/vortex.png",
    category: "DeFi",
    usdg_amount: 60_000,
    status: "completed",
    countdown_target: pastDate(14),
    rules_md:
      "### Program\n6 weeks · reference client + security review.\n\n### Payouts\nMilestone-based USDC on Solana.",
    combinator_chart_url: "https://combinator.trade/market/intent-router",
    combinator_trade_url: "https://combinator.trade/market/intent-router",
    milestone_split: [34, 33, 33],
    milestones: [
      {
        id: "m13",
        hackathon_id: "h5",
        milestone_order: 1,
        title: "Spec + reference client",
        amount_usdg: 20_000,
    ...
    proposals: [
      {
        ...
        builder_id: "b1",
        builder: mockBuilders[0],
        title: "SVM-native intent envelopes",
        description_md: "Composable intents with explicit settlement paths and fee caps.",
        approach_md: "Anchor + custom CPI adapters.",
        timeline_md: "6 weeks.",
        github_url: "https://github.com/alicesol/intent-envelopes",
        demo_url: "",
        team_members: [],
        market_odds: 0.51,
        submitted_at: pastDate(130),
      },
      {
        id: "p8",
        hackathon_id: "h5",
        builder_id: "b2",
        builder: mockBuilders[1],
        title: "Batch router for retail swaps",
        description_md: "Batches retail flow through a single vault with MEV-aware ordering.",
        approach_md: "Rust router, Jito hints.",
        timeline_md: "6 weeks.",
        github_url: "https://github.com/bobbuilder/batch-router",
        demo_url: "",
        team_members: [],
        market_odds: 0.38,
        submitted_at: pastDate(125),
      },
    ],
    created_at: pastDate(145),
  },
  {
    id: "h6",
    idea_title: "xNFT Loyalty Rails",
    idea_slug: "xnft-loyalty-rails",
    idea_image_url: "/portfolio/megaphone.png",
    category: "Consumer",
    usdg_amount: 22_000,
    status: "completed",
    countdown_target: pastDate(40),
    rules_md: "### Deliverables\nWallet-linked loyalty, merchant SDK, audit notes.",
    combinator_chart_url: "https://combinator.trade/market/xnft-loyalty",
    combinator_trade_url: "https://combinator.trade/market/xnft-loyalty",
    ...
    milestones: [
      {
        ...
        hackathon_id: "h6",
        milestone_order: 1,
        title: "MVP + merchant SDK",
        amount_usdg: 11_000,
        deadline: pastDate(95),
        status: "paid",
        paid_to: "carol.dev",
      },
      {
    ...
    proposals: [
      {
        ...
        builder_id: "b3",
        builder: mockBuilders[2],
        title: "Stamped xNFT receipts for IRL perks",
        description_md: "Tap-to-claim perks with on-chain receipt graph.",
        approach_md: "Metaplex + mobile deep links.",
        timeline_md: "4 weeks.",
        github_url: "https://github.com/caroldev/xnft-stamps",
        demo_url: "https://loyalty.spark.example",
        team_members: [],
        market_odds: 0.62,
        submitted_at: pastDate(100),
      },
    ],
    created_at: pastDate(110),
  },
  {
    id: "h7",
    idea_title: "Treasury OS for On-Chain Teams",
    idea_slug: "treasury-os-onchain",
    idea_image_url: "/portfolio/chips.png",
    category: "Treasury",
    usdg_amount: 75_000,
    status: "open",
    countdown_target: futureDate(9),
    rules_md:
      "### Build window\n8 weeks · reporting, mandates, and settlement windows.\n\n### Judging\nCombinator market on shipped artifacts.",
    combinator_chart_url: "https://combinator.trade/market/treasury-os",
    combinator_trade_url: "https://combinator.trade/market/treasury-os",
    milestone_split: [25, 35, 40],
    milestones: [
      {
        id: "m18",
        hackathon_id: "h7",
        milestone_order: 1,
        title: "Read-only portfolio + CSV",
        amount_usdg: 18_750,
        deadline: futureDate(21),
        status: "active",
      },
    ...
    proposals: [
      {
        ...
        builder_id: "b4",
        builder: mockBuilders[3],
        title: "Runway Sentinel",
        description_md: "Multi-sig aware runway model with headcount and burn deltas.",
        approach_md: "Helius + internal ledger schema.",
        timeline_md: "Weeks 1–3 data; 4–6 policy UI.",
        github_url: "https://github.com/daveonchain/runway-sentinel",
        demo_url: "",
        team_members: [],
      ...
      },
      {
        ...
        hackathon_id: "h7",
        builder_id: "b5",
        builder: mockBuilders[4],
        title: "Mandate Desk",
        description_md: "Desk workflows for segregated mandates with attested approvals.",
        approach_md: "React + program-controlled PDAs.",
        timeline_md: "8 weeks.",
        github_url: "https://github.com/emmadesign/mandate-desk",
        demo_url: "",
        team_members: [],
        submitted_at: pastDate(2),
      },
  ...
  {
    id: "h8",
    idea_title: "Agentic Swap Guard",
    idea_slug: "agentic-swap-guard",
    idea_image_url: "/portfolio/orb.png",
    category: "Security",
    usdg_amount: 45_000,
    status: "upcoming",
    countdown_target: futureDate(18),
    rules_md: "### Kickoff\nAgents must prove policy bundles before routing swaps.\n\n### Prize\nUp to $45k USDG across milestones.",
    combinator_chart_url: "",
    combinator_trade_url: "",
    milestone_split: [30, 30, 40],
    milestones: [
  ...
  {
    id: "h-opb",
    idea_title: "Opinion Bet",
    idea_slug: "opinion-bet",
    idea_image_url: "/portfolio/chips.png",
    category: "Consumer",
    usdg_amount: 25_000,
    status: "open",
    countdown_target: futureDate(21),
    rules_md:
      "### Program\nShip the core opinion market: ticketed sides, live odds, moderated threads, and settlement hooks that match the raise timeline on the idea page.\n\n### Prize\nMilestone-weighted USDG for working software and audit-ready settlement flows.\n\n### Review\nSpark + community review; deliverables must be demoable on devnet.",
    combinator_chart_url: "https://justspark.fun/hackathons/h-opb",
    combinator_trade_url: "https://justspark.fun/hackathons/h-opb",
    milestone_split: [40, 35, 25],
    milestones: [
      {
        id: "m-opb-1",
        hackathon_id: "h-opb",
        milestone_order: 1,
        title: "Ticket + pool client",
        amount_usdg: 10_000,
        deadline: futureDate(14),
        status: "locked",
      },
